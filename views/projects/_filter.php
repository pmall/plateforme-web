...
<form action="<?= $url ?>" method="get">
  <fieldset>
    ...
    <? endif; ?>
    <input name="name" type="text" value="<?= h($filter['name']) ?>" placeholder="Nom du projet" />
    <select name="type">
    ...
    <input name="cell_line" type="text" value="<?= h($filter['cell_line']) ?>" placeholder="Lignée cellulaire" />
